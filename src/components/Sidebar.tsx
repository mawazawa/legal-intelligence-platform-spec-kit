...
const navigation: NavItem[] = [
  ...
  { name: 'Pleading: Declaration', href: '/pleadings/responsive', icon: <FileText className="h-5 w-5" />, badge: 'NEW' },
  { name: 'Pleading: Rotert Decl.', href: '/court-filing/rotert-declaration', icon: <FileText className="h-5 w-5" />, badge: 'NEW' },
  { name: 'Pleading: MPA', href: '/pleadings/mpa', icon: <FileText className="h-5 w-5" />, badge: 'NEW' },
  ...
  { name: 'Continuances', href: '/analytics/continuances', icon: <BarChart3 className="h-5 w-5" />, badge: 'NEW' },
  { name: 'Communications', href: '/analytics/communications', icon: <BarChart3 className="h-5 w-5" />, badge: 'NEW' },
